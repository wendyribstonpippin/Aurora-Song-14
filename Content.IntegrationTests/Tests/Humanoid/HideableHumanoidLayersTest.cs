...
public sealed class HideableHumanoidLayersTest : InteractionTest
{
    ...
    public async Task DependentHiding()
    {
        ...
        await Client.WaitAssertion(() =>
        {
            ...
            var snoutIndex = spriteSystem.LayerMapGet(CPlayer, "VulpSnout-muzzle"); // Aurora's Song - Delta sprites
            var snoutCoverIndex = spriteSystem.LayerMapGet(CPlayer, "VulpSnout-nose"); // Aurora's Song - Delta sprites
