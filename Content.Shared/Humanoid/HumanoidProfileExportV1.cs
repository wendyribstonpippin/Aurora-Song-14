...
{
    public const int DefaultBalance = 50000; // Frontier
    ...
    public int BankBalance { get; private set; } = HumanoidCharacterProfile.DefaultBalance; // Frontier: Bank balance
...
public sealed partial class HumanoidCharacterAppearanceV1
{
    ...
    public HumanoidCharacterAppearance ToV2(ProtoId<SpeciesPrototype> species)
    {
        ...
        return new HumanoidCharacterAppearance(EyeColor, SkinColor, markingManager.ConvertMarkings(incomingMarkings, species), Height, Width);
    }
}
