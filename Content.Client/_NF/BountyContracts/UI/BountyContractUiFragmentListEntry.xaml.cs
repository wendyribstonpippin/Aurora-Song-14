...
using Robust.Shared.Prototypes; // Aurora Song
...
{
    private readonly IPrototypeManager _proto = default!; // Aurora Song
    ...
    public BountyContractUiFragmentListEntry(BountyContract contract, bool canRemoveContracts)
    {
        ...
        if (!_proto.TryIndex(contract.Category, out var meta))
            meta = _proto.Index(SharedBountyContractSystem.FallbackCategory);
